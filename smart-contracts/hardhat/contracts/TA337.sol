...
contract TokenAuthorityLegacy is Ownable {
    ...
    mapping(address => bool) internal whitelist; // krnlNodePubKey to bool
    mapping(bytes32 => bool) internal runtimeDigests; // runtimeDigest to bool
    mapping(uint256 => bool) internal kernels; // kernelId to bool
    ...
    constructor(address initialOwner) Ownable(initialOwner) {
        ...
        // for (uint256 i = 1300; i < 1500; i++) {
        //     kernels[i] = true;
        // }

        whitelist[address(0xc770EAc29244C1F88E14a61a6B99d184bfAe93f5)] = true;
        whitelist[address(0xf59f9Fbfd15254dDC47C5bAAE45abCFe8597Ad46)] = true;
    }
    ...
    modifier onlyAuthorized(bytes calldata auth) {
        ...
        // require(_verifyRuntimeDigest(runtimeDigest, runtimeDigestSignature));
        _;
    }
